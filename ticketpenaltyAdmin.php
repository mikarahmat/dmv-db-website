    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                    ...
                    $result = mysqli_query($conn, "SELECT * FROM penalty_ticket");
                    while($student = mysqli_fetch_array($result)){
                    echo "<tr>";
                    echo "<td>" .$student['ticketID']."</td>";
                    echo "<td>" .$student['plate']."</td>";
                    ...
                    echo "<td>
                    <a href='a-penaltyticket.php' class='view' title='Create' data-toggle='tooltip'><i class='material-icons'>&#xE417;</i></a>
                    <a href='a-penaltyticketedit.php?ID=$student[ticketID]' class='edit' title='Edit' data-toggle='tooltip'><i class='material-icons'>&#xE254;</i></a>
                    <a href='a-penaltyticketdelete.php?ID=$student[ticketID]' class='delete' title='Delete' data-toggle='tooltip'><i class='material-icons'>&#xE872;</i></a>
                    </td>";
                echo "</tr>";
    }
?>
            ...
            <button class="btn btn-primary" onclick="redirectToIndex()">Add Penalty</button>
            <button class="btn btn-primary" onclick="redirectToViewOwner()">View Ticket Owner</button>
            <script>
                function redirectToIndex() {
                window.location.href = "a-penaltyticket.php";
                }
                function redirectToViewOwner() {
                window.location.href = "ticketpenaltyUserOwner.php";
                }
            </script>
        </div>
    </div>  

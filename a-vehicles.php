...
if ($results->num_rows > 0) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['vehicles'])) {
        ...
        $result = mysqli_query($conn, "INSERT INTO vehicles (vehicleID, plate, model, year, ID) VALUES ('$vid', '$plate', '$model', '$year','$id')");
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4">
          <div class="portfolio-info">
            <h3>Add Vehicles</h3>
        <form name="update" method="post" action="a-vehicles.php">
	<div class="container">
		<h2 class="text-center">Add Vehicles Detail</h2>
		<form method="POST">
            <div class="form-group">
				<label for="ID">Costumer ID:</label>
			...
			<div class="form-group">
				<button type="submit" class="btn btn-primary" name="vehicles">Add</button>
				<button type="button" class="btn btn-default" onclick="location.href='vehicleAdmin.php'">Return</button>
			</div>
		</form>
	</div>

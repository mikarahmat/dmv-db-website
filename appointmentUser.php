    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                    ...
                    $result = mysqli_query($conn, "SELECT * FROM appointment WHERE ID = $user_id");
                    while($student = mysqli_fetch_array($result)){
                    echo "<tr>";
                    echo "<td>" .$student['appointmentID']."</td>";
                    echo "<td>" .$student['date']."</td>";
                    echo "<td>" .$student['startTime']."</td>";
                    echo "<td>" .$student['endTime']."</td>";
                    echo "<td>" .$student['officeName']."</td>";
                    echo "<td>" .$student['description']."</td>";
                    echo "<td>" .$student['ID']."</td>";
                    echo "<td>
                        <a href='c-appointment.php' class='view' title='Create' data-toggle='tooltip'><i class='material-icons'>&#xE417;</i></a>
                        <a href='c-appointmentedit.php?ID=$student[appointmentID]' class='edit' title='Edit' data-toggle='tooltip'><i class='material-icons'>&#xE254;</i></a>
                        <a href='c-appointmentdelete.php?ID=$student[appointmentID]' class='delete' title='Delete' data-toggle='tooltip'><i class='material-icons'>&#xE872;</i></a>
                        </td>";
                    echo "</tr>";
    }
?>
            ...
            <button class="btn btn-primary" onclick="redirectToIndex()">Make Appointment</button>
            <script>
                function redirectToIndex() {
                window.location.href = "c-appointment.php";
                }
            </script>
        </div>
    </div>  

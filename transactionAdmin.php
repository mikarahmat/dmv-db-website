    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                    ...
                    echo "<tr>";
                    echo "<td>" .$student['transactionID']."</td>";
                    echo "<td>" .$student['amount']."</td>";
                    echo "<td>" .$student['date']."</td>";
                    echo "<td>" .$student['officeName']."</td>";
                    echo "<td>" .$student['ticketID']."</td>";
                    echo "<td>
                        <a href='a-transaction.php' class='view' title='Create' data-toggle='tooltip'><i class='material-icons'>&#xE417;</i></a>
                        <a href='a-transactionedit.php?ID=$student[transactionID]' class='edit' title='Edit' data-toggle='tooltip'><i class='material-icons'>&#xE254;</i></a>
                        </td>";
                    echo "</tr>";
    }
?>
            ...
            <button class="btn btn-primary" onclick="redirectToIndex()">Pay</button>
            <script>
                function redirectToIndex() {
                window.location.href = "a-transaction.php";
                }
            </script>
        </div>
    </div>  

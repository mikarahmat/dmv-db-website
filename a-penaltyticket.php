...
$results = mysqli_query($conn, "SELECT * FROM register WHERE ID = $user_id");

if ($results->num_rows > 0) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['penalty_ticket'])) {
            ...
            $result = mysqli_query($conn, "INSERT INTO penalty_ticket (plate, description, amount, issueDate, dueDate, status, ID) VALUES ('$plate', '$desc', '$amount', '$iDate', '$dDate', '$status', '$id')");
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4">
          <div class="portfolio-info">
            <h3>Add Penalty Ticket</h3>
        <form name="update" method="post" action="a-penaltyticket.php">
			...
			<div class="form-group">
				<button type="submit" class="btn btn-primary" name="penalty_ticket">Penalty Ticket</button>
				<button type="button" class="btn btn-default" onclick="location.href='ticketpenaltyAdmin.php'">Return</button>
			</div>
		</form>
	</div>

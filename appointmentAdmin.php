    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                    ...
                    echo "<td>
                        <a href='a-appointment.php' class='view' title='Create' data-toggle='tooltip'><i class='material-icons'>&#xE417;</i></a>
                        <a href='a-appointmentedit.php?ID=$student[appointmentID]' class='edit' title='Edit' data-toggle='tooltip'><i class='material-icons'>&#xE254;</i></a>
                        <a href='a-appointmentdelete.php?ID=$student[appointmentID]' class='delete' title='Delete' data-toggle='tooltip'><i class='material-icons'>&#xE872;</i></a>
                        </td>";
                    echo "</tr>";
    }
?>
            ...
            <script>
                ...
                window.location.href = "a-appointment.php";
                }
            </script>
        </div>
    </div>  

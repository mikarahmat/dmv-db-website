<?php
        ...
        if(isset($_POST['update'])){
            ...
            // update user data
            $result = mysqli_query($conn, "UPDATE penalty_ticket SET plate='$plate', description = '$desc', amount = '$amount', issueDate='$idate', dueDate='$ddate', status = '$status' WHERE ticketID=$id");
        ...
        $result = mysqli_query($conn, "SELECT * FROM penalty_ticket WHERE ticketID=$id");

        while($pt = mysqli_fetch_array($result)) {
            $plate = $pt['plate'];
            $desc = $pt['description'];
            $amount = $pt['amount'];
            $idate = $pt['issueDate'];
...
<html> 
<head>
    <title>Edit Penalty Ticket Data</title>
    <meta charset="utf-8">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4">
        <div class="portfolio-info">
          <h3>Edit Penalty Ticket</h3>
        
            
          <form name="update" method="post" action="a-penaltyticketedit.php">
        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="issueDate" value=<?php echo $idate; ?>>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='ticketpenaltyAdmin.php'">Cancel</button>
                            </div>
    </form>
    </div>
        </div>

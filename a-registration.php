...
if ($results->num_rows > 0) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['registration'])) {
            ...
            $result = mysqli_query($conn, "INSERT INTO registration (registrationID, plate, registrationDate, expiryDate, ID) VALUES ('$registrationID','$plate', '$rdate', '$edate', '$id')");
  ...
  <section id="portfolio-details" class="portfolio-details">
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <form name="update" method="post" action="a-registration.php">
	<div class="container">
		<h2 class="text-center">Regist your Vehicle</h2>
		<form method="POST">
        <div class="form-group">
				<label for="registrationID">Registration ID:</label>
				<input type="number" class="form-control" name="registrationID" id="registrationID">
			</div>
            <div class="form-group">
			...
			<div class="form-group">
				...
				<button type="button" class="btn btn-default" onclick="location.href='registrationAdmin.php'">Return</button>
			</div>
		</form>
	</div>

...
<title>User Penalty Ticket</title>
...
<div class="container-xl">
    ...
    $result = mysqli_query($conn, "SELECT register.fName, register.lName, penalty_ticket.ticketID, penalty_ticket.plate, penalty_ticket.description, penalty_ticket.amount, penalty_ticket.issueDate, penalty_ticket.dueDate, penalty_ticket.status, penalty_ticket.ID 
                                   FROM register 
                                   INNER JOIN penalty_ticket 
                                   ON register.ID = penalty_ticket.ID 
                               ");
    ...
    ?>
            ...
            <button class="btn btn-primary" onclick="redirectToIndex()">Return</button>
            <script>
                function redirectToIndex() {
                window.location.href = "ticketpenaltyAdmin.php";
                }
            </script>
        </div>
    </div>  

    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                    ...
                    echo "<tr>";
                    echo "<td>" .$student['registrationID']."</td>";
                    echo "<td>" .$student['plate']."</td>";
                    echo "<td>" .$student['registrationDate']."</td>";
                    echo "<td>" .$student['expiryDate']."</td>";
                    echo "<td>" .$student['ID']."</td>";
                    echo "<td>
                    <a href='a-registration.php' class='view' title='Create' data-toggle='tooltip'><i class='material-icons'>&#xE417;</i></a>
                    <a href='a-registrationedit.php?ID=$student[registrationID]' class='edit' title='Edit' data-toggle='tooltip'><i class='material-icons'>&#xE254;</i></a>
                    <a href='a-registrationdelete.php?ID=$student[registrationID]' class='delete' title='Delete' data-toggle='tooltip'><i class='material-icons'>&#xE872;</i></a>
                    </td>";
                echo "</tr>";
    }
?>
            ...
            <button class="btn btn-primary" onclick="redirectToIndex()">Regist a Vehicle</button>
            <script>
                function redirectToIndex() {
                window.location.href = "a-registration.php";
                }
            </script>
        </div>
    </div>  

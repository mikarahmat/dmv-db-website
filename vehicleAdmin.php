    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                    ...
                    echo "<tr>";
                    echo "<td>" .$student['vehicleID']."</td>";
                    echo "<td>" .$student['plate']."</td>";
                    echo "<td>" .$student['model']."</td>";
                    echo "<td>" .$student['year']."</td>";
                    echo "<td>" .$student['ID']."</td>";
                    echo "<td>
                        <a href='a-vehicles.php' class='view' title='Create' data-toggle='tooltip'><i class='material-icons'>&#xE417;</i></a>
                        <a href='a-vehiclesedit.php?ID=$student[vehicleID]' class='edit' title='Edit' data-toggle='tooltip'><i class='material-icons'>&#xE254;</i></a>
                        <a href='a-vehiclesdelete.php?ID=$student[vehicleID]' class='delete' title='Delete' data-toggle='tooltip'><i class='material-icons'>&#xE872;</i></a>
                        </td>";
                    echo "</tr>";
    }
?>
            ...
            <button class="btn btn-primary" onclick="redirectToIndex()">Add Vehicle</button>
            <script>
                function redirectToIndex() {
                window.location.href = "a-vehicles.php";
                }
            </script>
        </div>
    </div>  

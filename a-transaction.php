  ...
  <section id="portfolio-details" class="portfolio-details">
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <form name="update" method="post" action="a-transaction.php">
	<div class="container">
		...
		<form method="POST">
			...
			<div class="form-group">
				...
				<button type="button" class="btn btn-default" onclick="location.href='transactionAdmin.php'">Return</button>
			</div>
		</form>
	</div>

...
if ($results->num_rows > 0) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['transaction'])) {
            ...
            $result = mysqli_query($conn, "INSERT INTO transaction (ticketID, amount, date, officeName, ID) VALUES ('$tID', '$amount', '$date', '$office', '$id')");
            
        // Redirect the user back to the login page
        header("Location: transactionUser.php");
        exit;
    }
}
?>
...
<title>Create User Transaction</title>
	...
	<div class="container">
		<form method="POST">
            ...
            <div class="form-group">
				...
				<input type="number" class="form-control" name="ticketID" id="ticketID">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<button type="submit" class="btn btn-primary" name="transaction">Transaction</button>
				<button type="button" class="btn btn-default" onclick="location.href='transactionUser.php'">Cancel</button>
			</div>
		</form>
	</div>

<?php
        ...
        if(isset($_POST['update'])){
            ...
            // update user data
            $result = mysqli_query($conn, "UPDATE vehicles SET plate='$plate', model='$model', year='$year' WHERE vehicleID=$id");
        ...
        $result = mysqli_query($conn, "SELECT * FROM vehicles WHERE vehicleID=$id");
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4">
          <div class="portfolio-info">
            <h3>Edit Vehicles</h3>
        <form name="update" method="post" action="a-vehiclesedit.php">
        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='vehicleAdmin.php'">Cancel</button>
                            </div>
    </form>
    </div>
        </div>

  ...
  <section id="portfolio-details" class="portfolio-details">
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <form name="update" method="post" action="a-appointmentedit.php">
        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-default" onclick="location.href='appointmentAdmin.php'">Cancel</button>
                            </div>
    </form>
    </div>
        </div>

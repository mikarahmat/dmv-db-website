...
if ($results->num_rows > 0) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['appointment'])) {
            ...
            $result = mysqli_query($conn, "INSERT INTO appointment (date, startTime, endTime, officeName, description, ID) VALUES ('$date', '$stime', '$etime', '$office', '$desc', '$id')");
  ...
  <section id="portfolio-details" class="portfolio-details">
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <form name="update" method="post" action="a-appointment.php">
	<div class="container">
		<h2 class="text-center">Make Appoinment</h2>
		<form method="POST">
			...
			<div class="form-group">
				<button type="submit" class="btn btn-primary" name="appointment">Appointment</button>
				<button type="button" class="btn btn-default" onclick="location.href='appointmentAdmin.php'">Return</button>
			</div>
		</form>
	</div>
